...
we can also go with 13th loop but then soc will be less then 20% but we can recharge our battery after finishing the race 50 min early and getting SOC>20% in that case but is it allowed or not wan not known by me hence i chose to complete only 12 loops.
